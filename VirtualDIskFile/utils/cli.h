...
namespace utils{
    ...
    public methods:
        ...
        /**
         * @brief createDisk
         * @details This module invokes a wizzard to create a new virtual disk file
         */
        void createDisk();

        /**
         * @brief loadDisk
         * @details This module invokes a wizzard to load a virtual disk file
         */
        void loadDisk();
        /**
         * @brief listDisks
        ...
        /**
         * @brief selectDisk
         * @details This module prinits all loaded virtual disk files
